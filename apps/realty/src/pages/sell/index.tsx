     ...
     <SEO title='Sell' description='Page to sell properties' />
      <div className={styles.banner}>
        ...
        <div className={styles.banner_content}>
          <div>
            <p>BIENVENIDO!</p>
            <h2>Compramos tu inmueble en menos de 7 dias</h2>
          </div>
          <form action="">
      ...
      <section className={styles.section}>
        ...
        <p>Recibe por parte de nosotros una propuesta comercial para compar tu inmueble en plazo no mayor a 3 dias.</p>
      ...
      <section className={styles.section}>
        ...
        <p>Te ayudamos a promocionar tu propiedad al precio que tu desees, nosotros nos encargamos del proceso de venta de princpio a fin, desde la promocion de la propiedad hasta que recibas tu dinero.</p>
        </div>
